...
class CampusCentro extends StatefulWidget {
  const CampusCentro({Key? key});

  @override
  State<CampusCentro> createState() => _CampusCentro();
}

class _CampusCentro extends State<CampusCentro> {
  @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text("Campus Centro"),
